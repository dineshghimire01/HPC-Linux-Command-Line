...
- Example. mv "oldfilename" "newfilename" i.e. mv myfile.txt file.txt
...
- Function of the code: sudo is a command that allows you to elevate your user privilExamplees while executing the command to administrator privilExamplees. 
